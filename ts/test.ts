...
function newGoldenCases(): Record<string, any> {
  return {
    "7f": {},
    "007f": { b: true },
    "01017f": { u32: 1 },
    ...
    "057f7fffff7f": { f32: 3.4028234663852886e38 },
...
function decodeHex(s: any) {
  if (!s) return new Uint8Array();

  var a: any[] = [];
  for (var i = 0; i < s.length; i += 2) a.push(parseInt(s.substr(i, 2), 16));

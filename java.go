...
func GenerateJava(basedir string, packages []*Package) error {
	...
	for _, p := range packages {
		...
		for i, seg := range strings.Split(p.SuperClass, "/") {
			...
			scbuf.WriteString(seg)
			if IsJavaKeyword(seg) {
				scbuf.WriteByte('_')
			}
		}
		p.SuperClassNative = scbuf.String()
	}
...
const javaPackage = `// This file was generated by colf(1); DO NOT EDIT
...
// The compiler used schema file {{.SchemaFile}}.
...
{{if .Pkg.SuperClassNative}}
import {{.Pkg.SuperClassNative}};
{{end}}


/**
 * Data bean with built-in serialization support.
{{.DocText " *"}} * @author generated by colf(1)
 * @see <a href="https://github.com/pascaldekloe/colfer">Colfer's home</a>
 */
{{$class := .NameTitle}}public class {{$class}}
{{if .Pkg.SuperClassNative}}

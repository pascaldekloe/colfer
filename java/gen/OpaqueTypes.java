...
implements Serializable {
	...
	// Colfer internals
	private static final int FIXED_SIZE = 52;
	...
	public int unmarshal(byte[] buf, int off, int len) {
		...
		if (fixed_size <= 6) {
			...
			this.a8l = new byte[(int)(word0 >> 48) & 255];
		...
		if (fixed_size <= 13) {
			...
			this.a16l = new short[(int)(word1 >> 40) & 255];
		...
		if (fixed_size <= 26) {
			...
			this.a32l = new int[(int)(word3 >> 16) & 255];
		...
		if (fixed_size <= 51) {
			...
			this.a64l = new long[(int)(word6 >> 24) & 255];

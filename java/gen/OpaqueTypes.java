...
implements java.io.Serializable {
	...
	public int marshalWithBounds(byte[] buf, int off) {
		...
		java_unsafe.putByte(buf, off + JAVA_ARRAY_OFFSET + (6 * 8) + 0, (byte)(word6 >>> (0 * 8)));
		java_unsafe.putByte(buf, off + JAVA_ARRAY_OFFSET + (6 * 8) + 1, (byte)(word6 >>> (1 * 8)));
		java_unsafe.putByte(buf, off + JAVA_ARRAY_OFFSET + (6 * 8) + 2, (byte)(word6 >>> (2 * 8)));
		java_unsafe.putByte(buf, off + JAVA_ARRAY_OFFSET + (6 * 8) + 3, (byte)(word6 >>> (3 * 8)));

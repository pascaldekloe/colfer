...
func newGoldenCases() []*golden {
	return []*golden{
		...
		{"8700000001000000002e5da4e77f", testdata.O{T: time.Unix(math.MaxUint32+1, 777888999).In(time.UTC)}},
		{"87ffffffffffffffff000000007f", testdata.O{T: time.Unix(-1, 0).In(time.UTC)}},

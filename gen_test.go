...
func newGoldenCases() []*golden {
	return []*golden{
		...
		{"01ffffffff0f7f", testdata.O{U32: math.MaxUint32}},
		{"02017f", testdata.O{U64: 1}},
		{"02ffffffffffffffffff017f", testdata.O{U64: math.MaxUint64}},
		...
		{"84808080808080808080017f", testdata.O{I64: math.MinInt64}},
		...
		{"070000000055ef312a7f", testdata.O{T: time.Unix(1441739050, 0)}},
		{"870000000055ef312a2e5da4e77f", testdata.O{T: time.Unix(1441739050, 777888999)}},

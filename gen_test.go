...
func newGoldenCases() []*golden {
	return []*golden{
		...
		{"0755ef312a2e5da4e77f", testdata.O{T: time.Unix(1441739050, 777888999)}},
		{"8700000001000000002e5da4e77f", testdata.O{T: time.Unix(math.MaxUint32+1, 777888999)}},
		{"87ffffffffffffffff000000007f", testdata.O{T: time.Unix(-1, 0)}},
